...
        <div
          className="absolute inset-0 bg-cover bg-center" // Removed md:blur-lg
          style={{
...
            className="w-full p-3 bg-transparent border border-white rounded-lg text-white placeholder:text-white/70 focus:outline-none focus:ring-2 focus:ring-white"
          />
          <button className="relative w-full bg-black py-3 px-4 pr-12 rounded-lg font-semibold text-white hover:bg-gray-800 transition-colors mt-6 ">
